...
const TEASERS = [
  {
    ...
    href: '/hamlet/contacto',
  },
  {
    src: '/img/hamlet/ubicacion/centro-comercial.jpg',
  ...
  {
    src: '/img/hamlet/servicios/pileta-climatizada.jpg',
  ...
  return (
    <main>
      ...
      <div className="mt-0 md:mt-24">
        <SplitContent
          imageSrc="/img/hamlet/home/bosque-pinos-v2.jpg"
      ...
      <div className="mt-0 md:mt-24">
        <SplitContent
          imageSrc="/img/hamlet/servicios/club-de-chicos.jpg"
