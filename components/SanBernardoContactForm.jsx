...
export default function SanBernardoContactForm() {
  ...
  return (
    <section id="contacto" className="pb-16 pt-24 text-center md:pb-24 md:pt-32">
      <div className="mx-auto max-w-[1100px] px-6 md:px-8">
        <h2 className="text-3xl font-medium tracking-tight md:text-4xl">GESTIONÁ TU RESERVA</h2>
        <h3 className="mt-4 text-lg text-savoia-taupe-text">Contactanos y viví una experiencia inolvidable en San Bernardo</h3>
        ...
        {submitted ? (
          ...
          <form className="mx-auto mt-10 max-w-[600px] text-left" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <LockedHotelField label="Hotel Savoia San Bernardo" value="san bernardo" />
            </div>
