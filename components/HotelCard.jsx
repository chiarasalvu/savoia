...
export default function HotelCard({ title, titleHref, addressHref, addressText, phoneHref, phoneText }) {
  return (
    <div className="group flex h-full w-full flex-col items-center rounded-xl bg-savoia-light p-8 text-center text-savoia-charcoal shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
